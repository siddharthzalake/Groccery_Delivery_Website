  ...
  return (
    <div className='relative'>
      ...
      <div className='absolute inset-0 flex flex-col items-center md:items-start justify-end md:justify-center pb-24 md:pb-0 px-4 md:pl-16 lg:pl-24'>
        ...
        <h1 className='text-3xl md:text-4xl lg:text-5xl font-bold text-center md:text-left max-w-sm lg:max-w-lg leading-tight'>
        ...
        <div className='flex items-center mt-6 font-medium gap-4'>
          ...
          <Link
            to="/products"
            className='group hidden md:flex items-center gap-2 px-7 md:px-9 py-3'
          >
            Explore deals
            <img
